...
namespace WpfDemo.Common
{
    ...
    /// </summary>
    public class NonAlwaysTopmostPopup : Popup
    {
        /// <summary>
        /// Is Topmost dependency property
        /// </summary>
        public static readonly DependencyProperty IsTopmostProperty = DependencyProperty.Register("IsTopmost", typeof(bool), typeof(NonAlwaysTopmostPopup), new FrameworkPropertyMetadata(false, OnIsTopmostChanged));
        ...
        {
            var thisobj = (NonAlwaysTopmostPopup)obj;
        ...
        public void SetTopmostState(bool isTop)
        {
